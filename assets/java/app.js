  ...
  start: function() {
    ...
    for(var i =0; i < questions.length; i++){
        ...
        for (var r = 0; r < questions[i].answers.length; r++){
            $('#quiz-form').append(` <label for='question-${i}'><b>${questions[i].question}</b></label>`);
            $('#quiz-form').append(`<input type='radio' name='question-${i}' value="${questions[i].answers}">${questions[i].answers[r]}<br>`);
            // if(i === 0) {
            //     $('#quiz-form').append(` <label for='question-${i}'><b>${questions[i].question}</b></label>`);
	...
	// loop over the questions and answers
      ...
      $('#quiz-form').append(`<input type="submit" id="done" value="Submit">`);
